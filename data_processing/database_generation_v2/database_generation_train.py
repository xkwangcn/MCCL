...
def get_num_frame(data, frame_size, hop_size): #19
    T = data.shape[0]
...
if __name__ == '__main__':
    ...
    # output root
    root = '/your_data_path'
    root_dir = os.path.join(root, 'DAIC_WOZ-generated_database_VW10s', 'train')
    create_folders(root_dir)
    np.random.seed(1)

    # read training gt file
    gt_path = '/your_data_path/DAIC-WOZ-Unzip/train_split_Depression_AVEC2017.csv'
    ...
    for i in range(len(gt_df)):
        ...
        keypoints_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_CLNF_features3D.txt'
        gaze_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_CLNF_gaze.txt'
        AUs_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_CLNF_AUs.txt'
        pose_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_CLNF_pose.txt'
        hog_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_CLNF_hog.bin'
        audio_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_AUDIO.wav'
        text_path = f'/your_data_path/DAIC-WOZ-Unzip/{patient_ID}_P/{patient_ID}_TRANSCRIPT.csv'
        ...
        # visual
        filtered_fkps_features = fkps_features[:int(last_stop_time*visual_sr)]
        ...
        num_frame = sliding_window(filtered_fkps_features, filtered_gaze_features, filtered_AUs_features, 
                                   filtered_pose_features, filtered_hog_features, text_feature, visual_sr, window_size, overlap_size, output_root, patient_ID)
